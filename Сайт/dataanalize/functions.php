...
//function get_objects_sportzone($district_id)
//{
//    if ($district_id != ""){
//        $query = db_query("SELECT * FROM mos_objects_sportzone WHERE district_id='" . $district_id . "'");
//    }else{
//        $query = null;
//    }
//    return $query;
...
function distance2($lat_1, $lon_1, $lat_2, $lon_2) {
