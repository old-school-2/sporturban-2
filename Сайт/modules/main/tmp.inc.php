<div class="mapFilter" style="padding: 5px 30px;">
    ...
    <form method="POST" action="" id="form_updateMap" style="opacity: 0">
        ...
        <div class="row" style="padding-top: 10px">
            ...
            <div class="col-lg-3" style="margin-bottom: 20px;">
                ...
                <select id="select2" name="type[]" multiple="multiple" class="form-control js-example-basic-single">
            ...
            <div class="col-lg-3" style="margin-bottom: 20px;">
                <label>Спортзона:</label>
                <select id="select2" name="sportzone[]" multiple="multiple" class="form-control js-example-basic-single">
                    <?foreach ($sportzones as $d):?>
                    <option value="<?=$d['main_type_id']?>"><?=$d['main_type_name']?></option>
                    <?endforeach;?> 
                </select>
            </div>
