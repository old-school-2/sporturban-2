<?php
require_once $_SERVER['DOCUMENT_ROOT'] . "/bots/sporturban/config.php";
require_once $_SERVER['DOCUMENT_ROOT'] . "/lib/db.php";
require_once $_SERVER['DOCUMENT_ROOT'] . "/lib/functions.php";
require_once $_SERVER['DOCUMENT_ROOT'] . "/bots/sporturban/lib/bd.php";
require_once $_SERVER['DOCUMENT_ROOT'] . "/bots/sporturban/lib/utilities.php";
require_once $_SERVER['DOCUMENT_ROOT'] . "/bots/sporturban/lib/buttons.php";
require_once $_SERVER['DOCUMENT_ROOT'] . "/bots/sporturban/lib/interface.php";
require_once $_SERVER['DOCUMENT_ROOT'] . "/bots/sporturban/lib/functions.php";
